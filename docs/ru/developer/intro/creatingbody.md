...
Зарегистрируйте физические тела в Velthoric и измените флаги поведения в соответствии с тем, что вам нужно: (вам так же понадобится рендерер, вы можете ознакомиться с созданием такового  в примерах или)
